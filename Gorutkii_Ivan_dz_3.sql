...
/* Задание 1.
Оргазнизовать таблицу со связями 1-1
*/
DROP TABLE IF EXISTS attach_files;
CREATE TABLE attach_files(
	attach_file_id SERIAL PRIMARY KEY,
	FOREIGN KEY (attach_file_id) REFERENCES messages(id) ON UPDATE CASCADE ON DELETE CASCADE
) COMMENT = 'прикрепленные файлы к сообщению';

/* Задание 2.
Оргазнизовать таблицу со связями 1-М
*/
...
/* Задание 3.
Оргазнизовать таблицу со связями М-М
*/
...
CREATE TABLE musics(
	...
	media_id BIGINT UNSIGNED NOT NULL,
	PRIMARY KEY (music_album_id, media_id),
